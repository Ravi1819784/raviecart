      ...
      <div className="main-footer">
        ...
        <div className="footer-social">
          ...
          <div className="footer-icons">
            ...
            <a href="https://www.linkedin.com/in/ravi-singh-09a6ba165">
        ...
        <div className="about-footer">
          ...
          <div className="footer-about-link"> </div>
        </div>
...
<a href="mailto:ravisingh17200@gmail.com" style={{ textDecoration: "none", color: "white" }}> <div className="contact-icon" >
          ...
          >
            {" "}
            <div className="contact-icon" ><FaPhoneAlt className="mobile-icon" /> : +91-7828618763</div>
